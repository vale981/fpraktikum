...
Bei polykristallinen Proben erhält man als Beugungsmuster Debye-Scherrer-Ringe, also konzentrisch
angeordnete Kreise. Mit Hilfe des \(r_{hkl}\) Radius dieser Ringe lässt sich auf den Abstand der
Netzebenen stellen:

\begin{equation}\label{eq:scherrer}
...
Radien \(r_{hkl}\) der Beugungsringe ergibt (vereinfachte Form von~\eqref{eq:scherrer}).
...
Goldes, Debye-Scherrer-Ringe aufwies konnte als ein alternatives Verfahren zur Auswertung mit 
