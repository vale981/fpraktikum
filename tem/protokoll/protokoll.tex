...
\begin{figure}[h]
	...
	\begin{subfigure}{.29\textwidth}
		\includegraphics[width=.8\textwidth]{../messungen/Fokus_Latex/auswertung/Fokus0.jpg}
		\caption{Latexkugel im Fokus.}
		\label{fig:fokus}
	\end{subfigure}
	\begin{subfigure}{.29\textwidth}
		\includegraphics[width=.8\textwidth]{../messungen/Fokus_Latex/auswertung/Fokus20.jpg}
		\caption{Latexkugel im Unterfokus.}
		\label{fig:unterfok}
	\end{subfigure}
	\begin{subfigure}{.29\textwidth}
		\includegraphics[width=.8\textwidth]{../messungen/Fokus_Latex/auswertung/Fokus-20.jpg}
