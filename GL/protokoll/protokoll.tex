...
da ein genaues Ablesen wieder afgrund perspektivischer effekte
schwierig war.

Das sich ergebende Spektrogramm wurde mit einem Digitaloszilloskop am
...
\begin{eqnarray}
  \label{eq:unithertz}
  \si{u} = \frac{\text{FSR}}{t_2-t_1} =\SI{5.7e5}{\hertz} \\
  \Delta\si{u}  = \sqrt{\qty(\frac{\Delta\text{FSR}}{x_2-x_1})^2 +
  2\cdot\qty(\frac{\text{FSR}}{(x_2-x_1)^2}\Delta t)^2}  & = \SI{.7e5}{\hertz}
\end{eqnarray}
...
\begin{eqnarray}
  \label{eq:fwhmlaser}
  \overline{\text{FWHM}} = \SI{4.72\pm .31}{u} = \SI{2710000\pm
    180000}{\hertz} \\
...
\begin{eqnarray}
  ...
  \mathfrak{F}=\frac{\text{FSR}}{\text{FWHM}}=\SI{24.6\pm 1.6}{} \\
  \Delta\mathfrak{F} =
...
kommerziellen Lasers genau ortogonale Polarisation.
...
aus~\ref{fig:fskalib} entnommen und betr\"agt:
